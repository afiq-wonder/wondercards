...
interface WonderMissionScreenProps {
  card: WonderCard;
  onBack: () => void;
  onComplete: () => void;
}
...
export default function WonderMissionScreen({
  card,
  onBack,
  onComplete,
}: WonderMissionScreenProps) {
  return (
    <article className="overflow-hidden rounded-[2rem] border border-white/70 bg-white/78 shadow-[0_20px_60px_rgba(15,23,42,0.10)] backdrop-blur">
      <div className="relative">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,rgba(191,219,254,0.18),transparent_35%),radial-gradient(circle_at_top_right,rgba(196,181,253,0.10),transparent_30%),linear-gradient(180deg,rgba(255,255,255,0.94),rgba(255,255,255,0.75))]" />
        ...
        <div className="relative p-8 md:p-10">
          <div className="mx-auto flex max-w-2xl flex-col items-center text-center">
            ...
            <div className="flex flex-wrap justify-center gap-2">
              <PearlBadge>Wonder Mission</PearlBadge>
              <PearlBadge>{card.value}</PearlBadge>
          ...
          <div className="relative mt-8 grid gap-4 md:grid-cols-2">
            ...
            <div className="rounded-[1.6rem] bg-sky-50 p-6 ring-1 ring-sky-100">
              ...
              <p className="mt-3 leading-7 text-slate-700">
                This adventure helps your family practise{" "}
